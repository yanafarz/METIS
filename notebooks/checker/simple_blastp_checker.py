...
def find_blast_executable(blast_type):
    ...
    for folder in possible_paths:
        exe = os.path.join(folder, blast_type + ".exe")

        if os.path.isfile(exe):
            return exe

    print(f"ERROR: BLAST executable '{blast_type}' was not found.")
...
def main():
    ...
    while True:
        blast_type = prompt_choice(
            ...
            default=previous_inputs["blast_type"],
        )
